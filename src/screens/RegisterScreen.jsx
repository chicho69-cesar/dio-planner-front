...
import { Stack, Input, Pressable, Icon, Checkbox, Button, Text } from "native-base";
  ...
  >
    ...
    <FormElement to='retype' isRequired={true} mb={2}>
      <Input
        ...
        focusOutlineColor='gray.800'
        InputRightElement={
          <Pressable onPress={() => setShowRetypePassword(!showRetypePassword)}>
            <Icon
              as={<MaterialIcons name={showRetypePassword ? 'visibility': 'visibility-off' }/>}
              size={5} mr='2' color='gray.600'
            />
          </Pressable>
        }
    ...
    <FormElement mb={2}>
      <Checkbox
        value='accept' my='3' colorScheme='amber'
    ...
    <Button
      ...
      variant='subtle' rounded='full' px={10} py={2} shadow={2} mb={4} w='75%'
    ...
    <Pressable onPress={() => navigation.navigate('Login')} mt={10}>
      <Text color='black' fontSize='md'>
        ¿Ya tienes cuenta?{' '}
        <Text color='amber.400' fontWeight='semibold'>Inicia sesión</Text>
      </Text>
    </Pressable>
  </Stack>;
}
